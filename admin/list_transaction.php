...
<body>
    ...
    <main class="flex">
        ...
        <section class="w-full flex flex-col gap-5 m-10">
            <h3 class="text-2xl font-bold">List Transactions</h3>
                        ...
                        if ($result && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td class='flex gap-2'> 
                                        <a href='delete_transaction.php?id=" . htmlspecialchars($row["id"]) . "' class='bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded text-xs'>Delete</a> 
                                    </td>";
                                echo "</tr>";
                            }
                        } else {
